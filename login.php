...
if(isset($_GET['loginerror'])) {
 ...
 if(!empty($loginerror)){  echo '<p class="errmsg">Invalid login credentials, Please Try Again..</p>'; } ?>
  ...
  <button style="width: -800px;" type="submit" name="sublogin" class="btn btn-primary btn-group-lg form_btn"><a
							href="course.html" target="_blank"
							style="color:rgb(0, 0, 0)">Login</a></button>
</form>
