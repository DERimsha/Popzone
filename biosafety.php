<?php include 'filesLogicbiosafety.php';?>
<!DOCTYPE html>
<html lang="en">
		...
		<div class="container">
			<div class="section-title row text-center">
				<div class="col-md-8 offset-md-2">
					<p class="lead"><h1 style="color: rgb(255, 166, 0); letter-spacing: 1PX;">BIO-SAFETY</h1> </p>
				</div>
			</div><!-- end title -->
			...
			<ul>
				...
				<li><button style="width: 100%;" type="button" class="btn btn-outline-primary"><a
							href="biosafety/downloadsbiosafety.php" target="_blank"
			...
			<div class="body">
				...
				<div class="card">
					...
					<div class="content">
						<p class="lead"><h1 style="color: rgb(255, 166, 0); letter-spacing: 1PX;">BIO-C</h1> </p>
						<div  style="margin: 9px; " class="product-name">
