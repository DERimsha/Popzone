...
?>
      ...
      <?php if(isset($done)) 
      { ?>
    <div class="successmsg"><span style="font-size:100px;">&#9989;</span> <br> You have registered successfully . <br> <a href="login.php" style="color:#2a2727;">Login here... </a> </div>
      <?php } else { ?>
       <div class="signup_form">
		<form action="" method="POST">
    <div class="form-group">
    <label class="label_txt">ID </label>
...
<div class="form-group">
  ...
  <div class="form-group">
    <label class="label_txt">Password_user </label>
    <input type="password" name="password" class="form-control" required="">
  </div>
   <div class="form-group">
    <label class="label_txt">Gender </label>
    <input type="password" name="Gender" class="form-control" required="">
  </div>
  <div class="form-group">
    <label class="label_txt">Passcode </label>
    <input type="password" name="Passcode" class="form-control" required="">
  </div>
  <div class="form-group">
    <label class="label_txt">Contact_no </label>
    <input type="password" name="Contact_no" class="form-control" required="">
  </div>
  <div class="form-group">
    <label class="label_txt">Email </label>
  ...
  <div class="form-group">
    <label class="label_txt">DOB </label>
    <input type="password" name="DOB" class="form-control" required="">
  </div>
  <div class="form-group">
